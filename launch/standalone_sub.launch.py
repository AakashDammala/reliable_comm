"""
standalone_sub.launch.py - Launch file for standalone reliable subscriber

Launches standalone_sub with configurable parameters.
"""
...
def generate_launch_description():
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            'max_storage_size',
            default_value='1000',
            description='Maximum messages to store (for API consistency)'
        ),
        Node(
            package='reliable_comm',
            executable='standalone_sub',
            name='standalone_sub',
            parameters=[{
